...
## Installation
    ...
    go get github.com/cong520/gojenkins
...
API Reference: https://godoc.org/github.com/cong520/gojenkins

## Examples

For all of the examples below first create a jenkins object
```go
import "github.com/cong520/gojenkins"
